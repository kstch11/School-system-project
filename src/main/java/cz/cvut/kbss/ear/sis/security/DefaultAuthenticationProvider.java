package cz.cvut.kbss.ear.sis.security;

import cz.cvut.kbss.ear.sis.security.model.AuthenticationToken;
...
public class DefaultAuthenticationProvider implements AuthenticationProvider {
    ...
    public Authentication authenticate(Authentication authentication) throws AuthenticationException {
        ...
        LOG.trace("Authenticating user {}", authentication.getPrincipal().toString());
    ...
    public boolean supports(Class<?> aClass) {
        return UsernamePasswordAuthenticationToken.class.isAssignableFrom(aClass) || AuthenticationToken.class.isAssignableFrom(aClass);
    }
}
